#!/usr/bin/env python3
"""
NLP Extractor v5.0 - Hybrid RAG System
======================================
...
Uso:
    python process_nlp_from_db_v5.py --mode test --limit 10
    python process_nlp_from_db_v5.py --mode production --batch 100
"""
...
from prompts.extraction_prompt_v5 import build_extraction_prompt


class NLPExtractorV5:
    """Extractor híbrido NLP v5.1 con RAG + LLM + Inferencia Contextual"""

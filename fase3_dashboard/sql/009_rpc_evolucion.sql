-- ============================================================
-- RPC: get_evolucion(p_filters jsonb, p_periodos int)
-- Reemplaza: getEvolucionSemanal, getEvolucionPeriodos
-- Soporta dos modos:
--   - Con fecha_desde/fecha_hasta: genera periodos comparativos de misma duracion
--   - Sin fechas: agrupa por semana (lunes-domingo)
-- ============================================================

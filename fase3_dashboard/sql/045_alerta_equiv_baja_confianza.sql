-- Migration 045: Alerta de equivalencias con baja confianza en get_pipeline_status()
-- Agrega una alerta warning cuando hay >50 grupos auto con similitud_minima < 0.87
...
BEGIN
  ...
  -- Equivalencias con baja confianza
  ...
  FROM (
    ...
    SELECT 7, 'warning'::text,
      v_equiv_baja_confianza || ' grupos de skills con baja confianza — revisar equivalencias',
      'ver_equiv_baja_confianza',
      'Hay grupos agrupados automáticamente con baja similitud entre miembros. Esto puede afectar la precisión del Perfil Argentino. Revisá los grupos con baja confianza en Equivalencias.'::text

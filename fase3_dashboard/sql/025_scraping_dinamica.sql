...
BEGIN
  ...
  SELECT json_build_object(
    ...
    'tasa_rotacion_promedio', ROUND(COALESCE(AVG(tasa_rotacion), 0)::numeric, 2),
    'tasa_republicacion_promedio', ROUND(COALESCE(AVG(tasa_republicacion), 0)::numeric, 2),
    'vida_media_promedio', ROUND(COALESCE(AVG(vida_media_dias), 0)::numeric, 1),

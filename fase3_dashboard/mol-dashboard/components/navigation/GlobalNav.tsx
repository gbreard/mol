...
const ADMIN_SIDEBAR_SECTIONS: AdminSidebarSection[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        items: [
          { href: "/admin/procesamiento/fabrica", label: "Fabrica", icon: Settings },
          ...
          { href: "/admin/aprendizaje", label: "Aprendizaje", icon: Target },
          { href: "/admin/procesamiento/perfil-argentino", label: "Perfil Argentino", icon: Shield },

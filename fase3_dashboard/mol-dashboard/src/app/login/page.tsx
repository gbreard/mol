    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50">
      <div className="max-w-md w-full bg-white rounded-lg shadow-sm border border-gray-200 p-8">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-gray-900">MOL Dashboard</h1>
          <p className="text-gray-500 mt-2 text-sm">Monitor de Ofertas Laborales</p>
        </div>
        ...
        <button
          ...
          disabled={loading}
          className="w-full py-2 px-4 border border-gray-300 rounded-md text-sm font-medium text-gray-700 flex items-center justify-center gap-3 hover:bg-gray-50 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
        >
        ...
        <p className="mt-8 text-center text-xs text-gray-500">
          OEDE - Observatorio de Empleo y Dinamica Empresarial
        </p>
      </div>
    </div>
  )

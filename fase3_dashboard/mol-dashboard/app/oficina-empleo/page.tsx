...
const MODULES = [
  {
    ...
    description: 'Identifica el perfil de competencias y conocimientos de un candidato',
    color: 'teal',
  },
  {
    ...
    description: 'Encontrá las ofertas laborales activas más compatibles con el perfil del candidato',
    color: 'blue',
  },
  {
    href: '/oficina-empleo/perfiles/futuro',
    icon: Map,
    title: 'Reconversión y recalificación ocupacional',
    description: 'Recomendá ocupaciones y formación para la reconversión laboral',
    color: 'purple',
  },
]

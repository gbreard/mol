...
# =====================================================================
echo "=== [1/6] Bumeran scraping: $(date) ===" >> "$LOG_FILE"
...
# =====================================================================
echo "=== [2/6] ZonaJobs scraping: $(date) ===" >> "$LOG_FILE"
...
# =====================================================================
echo "=== [3/6] ComputRabajo scraping: $(date) ===" >> "$LOG_FILE"
...
# =====================================================================
echo "=== [4/6] CABA scraping: $(date) ===" >> "$LOG_FILE"
...
# =====================================================================
echo "=== [5/6] Portal Empleo Nacional scraping: $(date) ===" >> "$LOG_FILE"
...
# =====================================================================
# Paso 6: Export incremental (para sync a local)
# =====================================================================
echo "=== [6/6] Export incremental: $(date) ===" >> "$LOG_FILE"

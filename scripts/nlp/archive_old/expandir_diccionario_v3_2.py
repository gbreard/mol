...
DICT_ACTUAL = '../../config/scraping/master_keywords.json'
DICT_BACKUP = '../../config/scraping/master_keywords_v3.1_backup.json'
DICT_NUEVO = '../../config/scraping/master_keywords_v3.2.json'

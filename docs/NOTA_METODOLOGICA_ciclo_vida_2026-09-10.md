...
El tablero pasa de mostrar **4 ofertas activas** a mostrar **~7.100**.

No aparecieron ofertas nuevas. Las 7.100 estaban en la base desde siempre,
marcadas como dadas de baja por un criterio equivocado.
...
El resultado es el que se esperaría de esa mecánica: de las ofertas activas
procesadas, el criterio viejo marcaba como baja al **100%**. Las 4 que
sobrevivían eran las que habían tenido la suerte de aparecer en la última
corrida.
...
Además de esas ~7.100, hay **~9.300 ofertas activas** en la base local que **no
llegan al tablero**.
...
del procesamiento. Es una pausa deliberada, no una falla. Cuando se reactive,
esas ~9.300 se incorporan y el número de activas del tablero va a subir de nuevo.

Dicho de otro modo: **~7.100 es lo que el tablero puede mostrar hoy, no el total
...
depende del mismo criterio, así que también cambia de cara: pasa de las 4
ofertas de antes a las ~7.100, agrupadas por empresa. Van a ver muchas más
empresas que antes. Vale la misma aclaración: no son empresas nuevas, estaban
escondidas detrás del filtro roto.
...
El criterio viejo se sigue calculando en paralelo durante una semana. Si algo no
cuadra, se vuelve atrás sin pérdida de datos.

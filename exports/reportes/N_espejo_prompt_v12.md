# FRENTE N — N2: Espejo de verificación del prompt v12

Punto de control ANTES de correr nada: cada **clave metodológica de Cyn** (28 casos) mapeada a la sección del prompt v12 que la implementa. La prosa de Cyn se compiló, no se reescribió.

**33 claves compiladas · los 28 casos citados · 0 claves sin cubrir.**

| Clave metodológica (Cyn) | Casos origen | Sección v12 |
|---|---|---|
...
## Prompt v12 completo (lo que corre)

```
Sos un analista experto en extraer las TAREAS de un aviso de empleo argentino. Tu trabajo es listar TODAS las acciones que el aviso atribuye al puesto, con la granularidad correcta y sin inventar.
